...
window.boot = function () {
    ...
    function loadConfig() {
        ...
        xhr.open('GET', 'https://xu.vin:8443/v1' + '/config/list', true);
        if (cc.sys.isNative) {
  ...
  function getResizeData() {
    ...
    if (false) {
        ...
        var bundledScript = settings.debug ? 'https://cdn.jsdelivr.net/gh/xin500k/vin@master/xuvin/web/v001/src/project.dev.js' : 'https://cdn.jsdelivr.net/gh/xin500k/vin@master/xuvin/web/v001/src/project.c734e.js';
        if (jsList) {
            jsList = jsList.map(function (x) {
                return 'https://cdn.jsdelivr.net/gh/xin500k/vin@master/xuvin/web/v001/src/' + x;
            });
    ...
    cc.AssetLibrary.init({
        libraryPath: 'https://cdn.jsdelivr.net/gh/xin500k/vin@master/xuvin/web/v001/res/import',
        rawAssetsBase: 'https://cdn.jsdelivr.net/gh/xin500k/vin@master/xuvin/web/v001/res/raw-',
...
// main.e27bb.js is qqplay and jsb platform entry file, so we must leave platform init code here
if (false) {
    ...
    if (isRuntime) {
        require('https://cdn.jsdelivr.net/gh/xin500k/vin@master/xuvin/web/v001/src/settings.572b8.js');
        require('https://cdn.jsdelivr.net/gh/xin500k/vin@master/xuvin/web/v001/src/cocos2d-runtime.js');
        require('jsb-adapter/engine/index.js');
    }
    else {
        require('https://cdn.jsdelivr.net/gh/xin500k/vin@master/xuvin/web/v001/src/settings.572b8.js');
        require('https://cdn.jsdelivr.net/gh/xin500k/vin@master/xuvin/web/v001/src/cocos2d-jsb.js');
